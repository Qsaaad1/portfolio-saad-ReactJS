  ...
  return (
    ...
    className="flex relative flex-col h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center ">
      ...
      <motion.img
        ...
        className=" z-20 -mb-20 md:mb-0 flex-shrink-0  w-32 h-32 mt-32  sm:w-64 sm:h-64 rounded-full object-cover  md:rounded-lg md:w-64 md:h-96 xl:h-[500px] xl:w-[500px] "
      />
