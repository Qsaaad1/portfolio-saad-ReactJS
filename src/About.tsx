  ...
  return (
    ...
    className="flex relative flex-col h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center ">
      ...
      <motion.img
        ...
        viewport={{ once: true }}
        src="https://private-user-images.githubusercontent.com/101616957/266399842-5ae70a26-004b-44a5-b6c2-5cdcb87633fe.jpg?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTEiLCJleHAiOjE2OTc0NTc3NjgsIm5iZiI6MTY5NzQ1NzQ2OCwicGF0aCI6Ii8xMDE2MTY5NTcvMjY2Mzk5ODQyLTVhZTcwYTI2LTAwNGItNDRhNS1iNmMyLTVjZGNiODc2MzNmZS5qcGc_.M3aTtKQHERsRqt3-zqCzfWPe1Mb-Fp9DWXIdEiKx8L4"
